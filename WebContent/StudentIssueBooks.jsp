...
<%
	ArrayList<ExpireIssuseBooksEntity> books=(ArrayList<ExpireIssuseBooksEntity>)request.getAttribute("books");
%>
...
%>
	<h1 class="text-center mt-5">All Issue Books</h1>
	<div class="container mt-5" style="background-color:white">
	  ...
	  %>
	    <tr class="mt-4">
	      ...
	      <td><a class="btn btn-warning" href="studentrenewbook?bookId=<%=books.get(i).getBookId()%>">ReNew</a></td>
	    </tr>
	   <%
	  	}
