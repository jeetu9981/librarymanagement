...
%>
	<h1 class="text-center mt-5">All Available Books</h1>
	<div class="container mt-5" style="background-color:white">
	  ...
	  %>
	    <tr class="mt-4">
	      ...
	      <td><a href="bookissueusers?bookId=<%=books.get(i).getId()%>"><img height="100" width="100" src="img\\<%=books.get(i).getImage()%>"></a></td>
	      <td><a class="btn btn-warning" href="EditBook.jsp?id=<%=books.get(i).getId()%>">Edit</a></td>
	      <td><a class="btn btn-danger" href="delete?id=<%=books.get(i).getId()%>">Delete</a></td>
	    </tr>
	   <%
	  	}
