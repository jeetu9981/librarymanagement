      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <li><a class="dropdown-item" href="#">Issue Books</a></li>
            <li><a class="dropdown-item" href="expireIssuebook">Expire Issue Books</a></li>
            <li><hr class="dropdown-divider"></li>
            <li><a class="dropdown-item" href="AddBook.jsp">Add Books</a></li>
            <li><a class="dropdown-item" href="dashboard">View Books</a></li>
            <li><a class="dropdown-item" href="deletebooks">Delete Books</a></li>
          </ul>
        </li>
      </ul>
