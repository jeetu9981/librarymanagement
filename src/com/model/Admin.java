...
public class Admin {
	...
	public Admin(String name, String libraryName, String address, String email, String password,
	...
	public Admin(int id, String name, String libraryName, String address, String email, String password,
			String memebershipNumber) {
		super();
		this.id = id;
		this.name = name;
